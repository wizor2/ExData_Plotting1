...
## Global_reactive_power, dateData$Sub_metering_1, dateData$Sub_metering_2, dateData$Sub_metering_3, 
## Voltage variables and change Time format
...
## write histogram in file 'plot3.png' based on project conditions
